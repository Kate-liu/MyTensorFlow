...
from FaceRecognitionModel.Tools.model import create_model
from FaceRecognitionModel.Tools.align import AlignDlib
...
# 2、人脸检测、对齐和提取（使用 OpenFace 的人脸对齐工具 AlignDlib）
# 初始化 OpenFace 人脸对齐工具，使用 Dlib 提供的 68 个关键点
alignment = AlignDlib('Data/landmarks.dat')
...
# 绘制训练模型
plot_model(nn4_small2, to_file='Data/nn4_small2_model_new.png', show_shapes=True)
...
# 绘制损失函数计算模型
plot_model(nn4_small2_train, to_file='Data/nn4_small2_train_new.png', show_shapes=True)

# 5、加载预训练模型 nn4.small2.v1
# 将csv文件，转为h5文件，https://github.com/iwantooxxoox/Keras-OpenFace/tree/master/weights
nn4_small2_pretrained = create_model()
nn4_small2_pretrained.load_weights('Data/models/nn4.small2.v1.h5')
...
# 6、预测模型
# metadata = load_metadata('Data/orig_images')
metadata = load_metadata('Data/images')
