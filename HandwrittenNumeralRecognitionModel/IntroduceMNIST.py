...
# WARNING:tensorflow:
# From E:\PYTHON_Space\TensorFlow\venv\lib\site-packages\tensorflow\contrib\learn\python\learn\datasets\mnist.py:290:
# DataSet.__init__ (from tensorflow.contrib.learn.python.learn.datasets.mnist)
# is deprecated and will be removed in a future version.

# download to the local MNIST dictionary
